    ...
    public void connect(String userN, String passW) {
        try (Connection conn = DriverManager.getConnection(
            ...
            while (userinput != 2) {
                ...
                // uses that number (above) and generates that number of room using randoming
                // generated numbers
                ...
                for (int i = 0; i < room; i++) {
                    ...
                    randApart = conn.prepareStatement(
                            "insert into apartment (apt_num, key, num_bed, num_bath, sqft,avabile) values ((?),(?),(?),(?),(?),(?))");
                ...
                amenities = conn
                        .prepareStatement("insert into amenities(key, pool, gym, doorman) values ((?),(?),(?),(?))");
